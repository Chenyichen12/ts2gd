 ...
 *
*/
protected _export_pack_patch(): int;
 ...
 *
*/
protected _export_zip_patch(): int;

/** Returns array of supported binary extensions for the full project export. */
protected _get_binary_extensions(): PackedStringArray;
...
protected _get_device_architecture(): string;
...
protected _get_preset_features(): PackedStringArray;
...
protected _has_valid_export_configuration(): boolean;

/** Returns [code]true[/code] if project configuration is valid. */
protected _has_valid_project_configuration(): boolean;
...
protected _is_executable(): boolean;
...
set_config_missing_templates(): void;
