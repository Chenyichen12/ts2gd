...
protected _set_credentials(username: string, password: string, ssh_public_key_path: string, ssh_private_key_path: string, ssh_passphrase: string): void;
...
create_diff_hunk(old_start: int, new_start: int, old_lines: int, new_lines: int): Dictionary<any, any>;
...
create_diff_line(new_line_no: int, old_line_no: int, content: string, status: string): Dictionary<any, any>;

/** Helper function to create a [Dictionary] used by editor to read the status of a file. */
create_status_file(file_path: string, change_type: int, area: int): Dictionary<any, any>;
