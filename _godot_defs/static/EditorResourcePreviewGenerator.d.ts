 ...
 *
*/
protected _generate(resource: Resource, size: Vector2i, metadata: Dictionary<any, any>): Texture2D;
 ...
 *
*/
protected _generate_from_path(path: string, size: Vector2i, metadata: Dictionary<any, any>): Texture2D;
