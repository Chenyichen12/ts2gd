...
agent_get_position(): Vector3;

/** Returns the radius of the specified [param agent]. */
agent_get_radius(): float;
...
agent_get_time_horizon_agents(): float;
...
agent_get_time_horizon_obstacles(): float;
...
is_baking_navigation_mesh(): boolean;
...
map_get_merge_rasterizer_cell_scale(): float;
...
map_get_use_async_iterations(): boolean;
...
map_set_merge_rasterizer_cell_scale(): void;
...
map_set_use_async_iterations(): void;
...
obstacle_get_velocity(): Vector3;

/** Returns the outline vertices for the specified [param obstacle]. */
obstacle_get_vertices(): PackedVector3Array;
 ...
 *
*/
region_get_closest_point_to_segment(): Vector3;
 ...
 *
*/
region_get_random_point(): Vector3;

/** Returns the global transformation of this [param region]. */
region_get_transform(): Transform3D;
...
region_get_use_async_iterations(): boolean;
...
region_set_use_async_iterations(): void;
 ...
 *
*/
simplify_path(): PackedVector3Array;
 ...
 *
*/
source_geometry_parser_set_callback(): void;
