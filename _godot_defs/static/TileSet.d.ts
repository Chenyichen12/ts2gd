 ...
 *
*/
get_alternative_level_tile_proxy(source_from: int, coords_from: Vector2i, alternative_from: int): any[];
 ...
 *
*/
map_tile_proxy(source_from: int, coords_from: Vector2i, alternative_from: int): any[];
